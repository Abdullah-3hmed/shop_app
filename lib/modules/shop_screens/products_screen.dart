...
import 'package:shop_app/shop_cubit/shop_app_cubit.dart';
...
class ProductsScreen extends StatelessWidget {
  ...
  Widget buildCategoryItem(
          CategoriesModel model, Map<String, dynamic> data, int index) =>
      Stack(
  ...
  Widget buildGridProduct(int index, HomeModel model, context) => Container(
        color: Colors.white,
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
